              ...
              <tbody>
                ...
                <tr class="c-table__row">
                  ...
                  <td class="c-table__cell">
                    @if($singleData->certificate_status == true)
                    <a class="c-badge c-badge--small c-badge--success" href="#">Certificate</a>
                    @else
                    <a class="c-badge c-badge--small c-badge--danger" href="#">Certificate</a>
                    @endif
                    @if($singleData->certificate_email_status == true)
                    <a class="c-badge c-badge--small c-badge--success" href="#">Email</a>
                    @else
